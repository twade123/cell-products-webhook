...
def handle_survey_completion():
    ...
    try:
        ...
        logging.info(f"🔍 Webhook handler extracted business name: '{business_name}'")
        logging.info(f"🔍 Raw business name field: '{survey_data.get('business name', 'NOT_FOUND')}'")
        
        # Let the create_subaccount_from_survey_data function handle validation
        ...
        logging.info(f"🏢 Business (from webhook): {business_name}")
